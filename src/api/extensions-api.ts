...
class ExtensionsApi {
    getAll(title: string = '') {
        return httpClient.get<ExtensionModel[]>('/extensions', {
            params: {
    ...
    install(id: number) {
        return httpClient.patch(`/extensions/${id}`, {installed: true} as Pick<ExtensionModel, 'installed'>);
    }

    uninstall(id: number) {
        return httpClient.patch(`/extensions/${id}`, {installed: false} as Pick<ExtensionModel, 'installed'>)
    }
}
