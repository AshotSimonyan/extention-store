  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <h2 className="text-divider">
          <span>2 Extension Description *</span>
        </h2>
        <Textarea
        ...
        <div className="button-group">
          ...
          <ButtonLink variant="outlined" to="/dev-company-dashboard">
            Cancel
          </ButtonLink>
        </div>
      </form>
